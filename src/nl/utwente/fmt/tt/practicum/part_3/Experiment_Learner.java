...
import nl.utwente.fmt.tt.practicum.part_3.util.NonDeterminismCheckingSUL;
import nl.utwente.fmt.tt.practicum.part_3.util.UserEQOracle;
 ...
 */
public class Experiment_Learner {
	//***********************************************************************************//
	...
	public static LearningAlgorithm<MealyMachine<?, String, ?, String>, String, Word<String>> loadLearner(
		...
		switch (learningMethod){
			...
			case TTT:
				return new TTTLearnerMealy<String, String>(alphabet, sulOracle, LocalSuffixFinders.FIND_LINEAR);
			case KearnsVazirani:
